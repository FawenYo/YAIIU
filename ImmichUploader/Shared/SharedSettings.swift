...
/// App Group: group.com.immich.uploader
class SharedSettings {
    static let shared = SharedSettings()
    
    private let appGroupIdentifier = "group.com.immich.uploader"
    ...
    // MARK: - Keychain
    private let keychainService = "com.immich.uploader.shared"
    private let keychainAccount = "api_key"
    private let keychainAccessGroup = "group.com.immich.uploader"
